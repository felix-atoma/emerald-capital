    ...
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-800 to-teal-900 flex items-center px-8 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 text-white">
          ...
          {/* CTA Button */}
          <button className="bg-teal-400 text-green-900 px-8 py-4 rounded-full font-bold text-lg hover:bg-teal-300 transition-all duration-300 shadow-xl hover:shadow-2xl">
