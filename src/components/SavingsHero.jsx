      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 text-white">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Grow Your <br />
            <span className="text-yellow-300">Wealth</span> with <br />
            <span className="italic font-light">Smart Savings</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-xl mb-10">
            Secure your financial future with our range of savings products. 
            Earn competitive interest rates while keeping your money safe and accessible.
          </p>
          ...
          <div className="relative">
            ...
            <div className="relative">
              <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-8 border-yellow-300 shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=800&h=800&fit=crop&crop=face"
                  alt="Person counting savings money"
