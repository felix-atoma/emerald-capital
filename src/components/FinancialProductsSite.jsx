...
const FinancialProductsSite = () => {
  ...
  return (
    <div ref={sectionRef} className="min-h-screen bg-gray-50 overflow-x-hidden relative">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-10 left-10 w-12 h-12 bg-purple-500 rounded-full opacity-60 animate-bounce" style={{ animationDuration: '3s' }}></div>
        <div className="absolute top-40 right-20 w-8 h-8 bg-pink-400 rounded-full opacity-50 animate-pulse" style={{ animationDuration: '2s' }}></div>
        <div className="absolute bottom-20 left-1/4 w-16 h-16 bg-blue-400 rounded-full opacity-40 animate-bounce" style={{ animationDuration: '4s' }}></div>
        <div className="absolute top-1/3 right-1/4 w-10 h-10 bg-purple-400 rounded-full opacity-50 animate-pulse" style={{ animationDuration: '3.5s' }}></div>
        <div className="absolute bottom-40 right-10 w-14 h-14 bg-red-300 rounded-full opacity-40 animate-bounce" style={{ animationDuration: '2.5s' }}></div>
      </div>
      ...
      <div className="relative z-10 pt-12 pb-24">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl md:text-6xl font-bold text-center mb-4">
            <span className="text-gray-700">Excellent financial products to</span>
            <br />
      ...
      <nav
  className={`${isNavFixed
      ? 'fixed top-20 left-8 right-8 shadow-lg'
      : 'relative'
    ...
    <div className="flex justify-center items-center space-x-8 py-4">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 relative">
              ...
              <div className="relative w-80 h-80 bg-gradient-to-br from-gray-300 to-gray-400 rounded-full overflow-hidden">
            ...
            <div className="md:w-1/2">
              <p className="text-sm font-semibold text-gray-600 mb-2">IPPIS Loan</p>
              <h2 className="text-5xl font-bold mb-6">
                <span className="text-gray-700">Prompt Cash Loans for</span>
                <br />
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">FG Civil Servants</span>
              </h2>
      ...
      <section id="mtgreen" className="relative py-20 bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <p className="text-sm font-semibold text-gray-600 mb-2">MTGreen:</p>
              <h2 className="text-5xl font-bold mb-6">
                <span className="text-gray-700">Say goodbye to high costs of fuel and</span>
                <br />
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">electricity today</span>
              </h2>
              <p className="text-gray-600 text-lg mb-8">
                Enjoy uninterrupted power supply to your homes, shops, and offices. Get a quality and affordable solar energy system with flexible repayments ranging from 1 to 12 months
              </p>
            ...
            <div className="md:w-1/2 relative">
              <div className="relative w-full h-96 bg-gray-200 rounded-lg overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-gray-400">Solar Energy System Image</div>
                </div>
              </div>
      ...
      <section id="mtloan" className="relative py-20 bg-white">
        <div className="absolute top-20 left-20 w-16 h-16 border-2 border-purple-300 rounded-full animate-spin" style={{ animationDuration: '8s' }}></div>
        <div className="absolute bottom-20 right-20 w-20 h-20 bg-blue-300 rounded-full opacity-30 animate-pulse"></div>
        
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 relative">
              <div className="relative w-80 h-80 bg-gradient-to-br from-orange-400 to-orange-500 rounded-full overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-48 h-96 bg-gray-800 rounded-3xl"></div>
                </div>
              </div>
              <div className="absolute -bottom-5 right-10 bg-white px-6 py-4 rounded-2xl shadow-lg">
                ...
                <p className="text-xs font-semibold">Loan Approved (00:05:10)</p>
                <p className="text-lg font-bold">N 2,000,000</p>
              </div>
            </div>
            <div className="md:w-1/2">
              <p className="text-sm font-semibold text-gray-600 mb-2">MTloan:</p>
              <h2 className="text-5xl font-bold mb-6">
                <span className="text-gray-700">Get your loan approved in</span>
                <br />
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">10 minutes or less!</span>
              </h2>
              <p className="text-gray-600 text-lg mb-8">
              ...
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-700">Disbursement in less than 10 minutes</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-gray-600">✓</span>
      ...
      <section id="sme" className="relative py-20 bg-gray-50">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              <p className="text-sm font-semibold text-gray-600 mb-2">SME Loan:</p>
              <h2 className="text-5xl font-bold mb-6">
                <span className="text-gray-700">Beta Business, </span>
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Beta Moni</span>
              </h2>
              <p className="text-gray-600 text-lg mb-8">
      ...
      <section id="car4cash" className="relative py-20 bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 relative">
              <div className="relative w-full h-96 bg-gray-100 rounded-lg overflow-hidden p-8">
                <div className="text-gray-400">Car valuation visual</div>
              </div>
              <div className="absolute -top-5 right-10 bg-white px-6 py-3 rounded-full shadow-lg border-2 border-green-500">
                <p className="text-sm font-semibold">2024 Benz = <span className="text-green-600">N100,000,000</span></p>
              </div>
            </div>
            <div className="md:w-1/2">
              ...
              <h2 className="text-5xl font-bold mb-6">
                ...
                <br />
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">much more!</span>
              </h2>
              <p className="text-gray-600 text-lg mb-8">
                Do you have a car and you need quick funds? Explore the value of your car and get the funds that you need.
              </p>
              <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-full transition flex items-center gap-2">
                Apply For Car4Cash
                <span>→</span>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2">
              ...
              <h2 className="text-5xl font-bold mb-6">
                ...
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">with us</span>
              </h2>
              <p className="text-gray-600 text-lg mb-8">
                Grow your wealth with us and enjoy guaranteed return on investments. Security guaranteed with easy liquidation.
              </p>
              <button className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-full transition flex items-center gap-2">
                Invest With Us
                <span>→</span>
            ...
            <div className="md:w-1/2 relative">
              <div className="relative w-96 h-96 border-4 border-red-500 rounded-full overflow-hidden flex items-center justify-center">
                <div className="text-gray-400 text-center">Investment growth tree visual</div>
              </div>
            </div>
          </div>
        </div>
