        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-2xl p-8 shadow-lg border border-orange-100">
              <h3 className="text-xl font-bold text-gray-900 mb-6">Asset Finance Calculator</h3>
              <div className="space-y-6">
                <div>
                ...
                <div>
                  ...
                  <select className="w-full border-2 border-orange-200 rounded-xl px-4 py-3 outline-none">
                    <option>Commercial Vehicle</option>
                    <option>Construction Equipment</option>
                    <option>Agricultural Machinery</option>
                    <option>Industrial Equipment</option>
                    <option>Processing Machine</option>
                  </select>
                </div>
                ...
                <div className="bg-white rounded-xl p-4 border border-orange-200">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="font-bold text-gray-900">₵320/month</span>
                  </div>
                  ...
                  <div className="flex justify-between items-center mt-2 pt-2 border-t">
                    ...
                    <span className="font-bold text-xl text-amber-600">₵13,020</span>
                  </div>
                </div>
              </div>
            </div>
