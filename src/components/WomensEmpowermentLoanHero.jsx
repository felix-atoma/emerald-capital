...
const WomensEmpowermentLoanHero = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-fuchsia-700 to-pink-900 flex items-center px-8 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 text-white">
          ...
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-500 to-pink-400 rounded-full px-6 py-3 mb-8 shadow-xl">
            ...
            <span className="font-bold">WOMEN'S EMPOWERMENT LOAN</span>
          </div>

          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Empower Her <br />
            <span className="text-yellow-300">Dreams</span> <br />
            <span className="italic font-light">with Purposeful Funding</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-xl mb-10">
            Invest in women's potential with our specialized empowerment loan. 
            Designed for women entrepreneurs, business owners, and aspiring 
            professionals to achieve financial independence and growth.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-lg">₵200-₵8K</div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-lg">Women</div>
                <div className="text-white/80 text-sm">Only</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
          ...
          <div className="relative">
            ...
            <div className="relative">
              <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-8 border-yellow-300 shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1551836026-d5c2c5af78e4?w=800&h=800&fit=crop&crop=center"
                  alt="Group of women entrepreneurs collaborating and working together"
              ...
              {/* Women empowerment decoration */}
              <div className="absolute -top-4 left-1/4 bg-fuchsia-600 rounded-full p-4 shadow-xl border-4 border-yellow-300">
...
export default WomensEmpowermentLoanHero;