...
const EducationSkillsLoanHero = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-indigo-700 to-purple-900 flex items-center px-8 md:px-16 lg:px-24">
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 text-white">
          ...
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-indigo-500 to-purple-400 rounded-full px-6 py-3 mb-8 shadow-xl">
            ...
            <span className="font-bold">EDUCATION & SKILLS LOAN</span>
          </div>

          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Invest in <br />
            <span className="text-yellow-300">Your Future</span> <br />
            <span className="italic font-light">with Education Funding</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-xl mb-10">
            Unlock your potential with our Education & Skills Loan. Finance your 
            education, vocational training, or skill development programs and build 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-lg">₵100-₵3K</div>
              ...
              <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-8 border-yellow-300 shadow-2xl">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&h=800&fit=crop&crop=center";
                  }}
                />
              </div>
...
export default EducationSkillsLoanHero;