...
import { Users, TrendingUp, Gem, Target } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="flex-1 text-white">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Premium Banking <br />
            <span className="text-green-300">For Your Business</span> <br />
            <span className="italic font-light">with Elite Services</span>
          </h1>
          <p className="text-lg md:text-xl text-white/90 max-w-xl mb-10">
            Experience exceptional banking designed exclusively for established 
            businesses. Enjoy priority service, dedicated relationship managers, 
            premium benefits, and tailored financial solutions for your enterprise.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-white/80 text-sm">Min. Balance</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <div className="text-white/80 text-sm">Treatment</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <div className="text-white/80 text-sm">Benefits</div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-white/20 rounded-full flex items-center justify-center">
          ...
          <div className="relative">
            ...
            <div className="relative">
              <div className="w-80 h-80 md:w-96 md:h-96 rounded-full overflow-hidden border-8 border-green-300 shadow-2xl">
                <img
                  src="https://images.unsplash.com/photo-1560179707-f14e90ef3623?w=800&h=800&fit=crop&crop=center"
                  alt="Premium business banking and executive financial services"
                  className="w-full h-full object-cover"
                  onError={(e) => {
                    e.target.onerror = null;
                    e.target.src = "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=800&h=800&fit=crop&crop=center";
                  }}
                />
              </div>
